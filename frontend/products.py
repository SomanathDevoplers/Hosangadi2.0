...
class prods(base_window):
    def __init__(self , root ,frames , dmsn , lbls ,title,validations,others):
        ...
        self.combo_tax1 = ttk.Combobox(self.main_frame  , font = ('Lucida Grande' , -int(self.main_hgt*0.03)) , width = 6 , values = [100,200]) 
        ...
        self.tree_frame.grid(row = 0 , column = 8 , rowspan = 15 , padx = int(self.main_wdt*0.01) , pady = int(self.main_hgt*0.01))
        ...
        self.btn_frame.grid(row = 15 ,column = 8 , sticky = con.E)
